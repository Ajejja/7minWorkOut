...
class TricepsActivity : AppCompatActivity() ,TextToSpeech.OnInitListener {

    private var binding: ActivityTricepsBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(binding?.TritoolbarExercise)
        ...
        binding?.TritoolbarExercise?.setNavigationOnClickListener {
            customDialogForBackButton()
        }
        exerciseList = TricepsConstants.defaultExerciceList()
        Log.d("TricepsActivity", "Exercise list size: ${exerciseList?.size}")
    ...
    private fun setupRestView() {
        ...
        exerciseList = exerciseList ?: TricepsConstants.defaultExerciceList()
        ...
        ExRestTimer = object : CountDownTimer(30000, 1000) {
            ...
            override fun onFinish() {
                ...
                if (currentExercisePosition < exerciseList?.size!! - 1) {
                    ...
                    Toast.makeText(
                        this@TricepsActivity,
                        "Congratulations ! You have completed the 7 minutes workout.",
                        Toast.LENGTH_SHORT
                    ).show()
                    speakOut("Congratulations ! You have completed the 7 minutes workout.")
                    finish()
                    val intent = Intent(this@TricepsActivity, FinalActivity::class.java)
