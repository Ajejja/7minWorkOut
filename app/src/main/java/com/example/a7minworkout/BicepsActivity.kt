...
import com.example.a7minworkout.databinding.ActivityBicepsBinding
...
class BicepsActivity : AppCompatActivity(), TextToSpeech.OnInitListener{
    private var binding: ActivityBicepsBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseList = BicepsConstants.defaultExerciceList()
    ...
    private fun setupRestView() {
        ...
        exerciseList = exerciseList ?: BicepsConstants.defaultExerciceList()
        ...
        ExRestTimer = object : CountDownTimer(30000, 1000) {
            ...
            override fun onFinish() {
                ...
                if (currentExercisePosition < exerciseList?.size!! - 1) {
                    ...
                    finish()
                    val intent = Intent(this@BicepsActivity, FinalActivity::class.java)
