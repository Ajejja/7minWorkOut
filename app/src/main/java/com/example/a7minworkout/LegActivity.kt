...
import com.example.a7minworkout.databinding.ActivityLegBinding
import com.example.a7minworkout.databinding.DialogCostumBackBinding
import java.lang.Exception
import java.util.Locale
import kotlin.collections.ArrayList

class LegActivity : AppCompatActivity(), TextToSpeech.OnInitListener {


    private var binding: ActivityLegBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exerciseList = LegConstants.defaultExerciceList()
    ...
    private fun setupRestView() {
        ...
        exerciseList = exerciseList ?: LegConstants.defaultExerciceList()
        ...
        ExRestTimer = object : CountDownTimer(30000, 1000) {
            ...
            override fun onFinish() {
                ...
                if (currentExercisePosition < exerciseList?.size!! - 1) {
                    ...
                    finish()
                    val intent = Intent(this@LegActivity, FinalActivity::class.java)
